    ...
    <form action="{{ route('admin.siswa.update', ['id' => $siswa->id]) }}" method="post">
      ...
      <div class="row">
        <div class="col-12 col-md-6">
          @if($siswa->program_keahlian == 'Teknik Otomotif')
          <div class="row mb-3">
            <div class="col-12 col-sm-6">
              <div class="form-check mb-2">
                <input type="radio" class="form-check-input @error('program_keahlian') is-invalid @enderror"
                  id="program_keahlian_to" name="program_keahlian" value="TO" autocomplete="off" required checked>
          ...
          @elseif($siswa->program_keahlian == 'Teknik Mesin')
          <div class="row mb-3">
            <div class="col-12 col-sm-6">
              <div class="form-check mb-2">
                <input type="radio" class="form-check-input @error('program_keahlian') is-invalid @enderror"
              ...
              <div class="form-check mb-2">
                <input type="radio" class="form-check-input @error('program_keahlian') is-invalid @enderror"
                  id="program_keahlian_tm" name="program_keahlian" value="TM" autocomplete="off" required checked>
                <label class="form-check-label" for="program_keahlian_tm">
                  Teknik Mesin
                </label>
              </div>
          ...
          @elseif($siswa->program_keahlian == 'Teknik Elektronika')
          <div class="row mb-3">
            <div class="col-12 col-sm-6">
              <div class="form-check mb-2">
                <input type="radio" class="form-check-input @error('program_keahlian') is-invalid @enderror"
              ...
              <div class="form-check mb-2">
                <input type="radio" class="form-check-input @error('program_keahlian') is-invalid @enderror"
                  id="program_keahlian_te" name="program_keahlian" value="TE" autocomplete="off" required checked>
                <label class="form-check-label" for="program_keahlian_te">
                  Teknik Elektronika
                </label>
              </div>
          ...
          @elseif($siswa->program_keahlian == 'Teknik Komputer Jaringan dan Telekomunikasi')
          <div class="row mb-3">
            <div class="col-12 col-sm-6">
              <div class="form-check mb-2">
                <input type="radio" class="form-check-input @error('program_keahlian') is-invalid @enderror"
            ...
            <div class="col-12 col-sm-6">
              <div class="form-check mb-2">
                <input type="radio" class="form-check-input @error('program_keahlian') is-invalid @enderror"
                  id="program_keahlian_tkjt" name="program_keahlian" value="TKJT" autocomplete="off" required checked>
                <label class="form-check-label" for="program_keahlian_tkjt">
                  Teknik Komputer Jaringan dan Telekomunikasi
                </label>
              </div>
          ...
          @elseif($siswa->program_keahlian == 'Pengembangan Perangkat Lunak dan Gim')
          <div class="row mb-3">
            <div class="col-12 col-sm-6">
              <div class="form-check mb-2">
                <input type="radio" class="form-check-input @error('program_keahlian') is-invalid @enderror"
            ...
            <div class="col-12 col-sm-6">
              ...
              <div class="form-check mb-2">
                <input type="radio" class="form-check-input @error('program_keahlian') is-invalid @enderror"
                  id="program_keahlian_pplg" name="program_keahlian" value="PPLG" autocomplete="off" required checked>
                <label class="form-check-label" for="program_keahlian_pplg">
                  Pengembangan Perangkat Lunak dan Gim
                </label>
              </div>
